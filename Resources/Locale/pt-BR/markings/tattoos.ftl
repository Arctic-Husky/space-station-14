...
marking-TattooCampbellLeftArm-tattoo_campbell_l_arm = Tatuagem no braço esquerdo (Campbelle)
marking-TattooCampbellLeftArm = Tatuagem no braço esquerdo (Campbelle)

marking-TattooCampbellRightArm-tattoo_campbell_r_arm = Tatuagem no braço direito (Campbelle)
marking-TattooCampbellRightArm = Tatuagem no braço direito (Campbelle)

marking-TattooCampbellLeftLeg-tattoo_campbell_l_leg = Tatuagem na perna esquerda (Campbelle)
marking-TattooCampbellLeftLeg = Tatuagem na perna esquerda (Campbelle)

marking-TattooCampbellRightLeg-tattoo_campbell_r_leg = Tatuagem na perna direita (Campbelle)
